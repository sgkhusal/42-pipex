...
#    Updated: 2022/03/29 07:04:16 by sguilher         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
echo "Test 1:"
printf "$RESET"
./pipex infile0 "catzzz" "bonjour" "wc -w" tests/outfiles/outfile
./pipex infile0 "cat" tests/outfiles/outfile
printf "\n"
...
rm tmp
./pipex infile0 "ls -l" "wc -l" tests/outfiles/outfile01
printf "$RED"
...
./pipex infile0 "" "" tests/outfiles/outfile11
printf "$RED"
...
./pipex infile0 "catzzz" "wc -w" tests/outfiles/outfile21
printf "$RED"
...
./pipex infile0 "lss" "wcc -l" tests/outfiles/outfile41
printf "$RED"
...
#./pipex infile0 "catzzz" "bonjour" "wc -w" tests/outfiles/outfile31
...
./pipex tests/infiles/infile_no_permission "ls -l" "wc -l" tests/outfiles/outfile51
...
./pipex tests/infiles/infile "lss" "wcc -l" tests/outfiles/outfile61
printf "$RED"
...
./pipex tests/infiles/infile "lss" "wc -l" tests/outfiles/outfile71
printf "$RED"
...
./pipex tests/infiles/infile "ls -l" "wcc -l" tests/outfiles/outfile81
printf "$RED"
...
./pipex tests/infiles/swim_good "" "tr 'o' '0'" tests/outfiles/outfile91
printf "$RED"
...
./pipex tests/infiles/swim_good "tr 'o' '0'" "" tests/outfiles/outfile101
printf "$RED"
...
./pipex tests/infiles/infile "" "" tests/outfiles/outfile111
printf "$RED"
...
./pipex tests/infiles/swim_good "find . -maxdeth 3 -name outfile*" "wc -l" tests/outfiles/outfile211
printf "$RED"
